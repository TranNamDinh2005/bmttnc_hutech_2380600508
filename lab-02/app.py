...
from cipher.playfair.playfair_cipher import PlayFairCipher # Sử dụng chữ F hoa
...
# --------------------- ROUTES PLAYFAIR (ĐÃ SỬA ĐỒNG BỘ CHỮ F HOA) ---------------------
@app.route("/playfair")
def playfair():
...
def playfair_creatematrix():
    data = request.json  
    key = data.get('key', '') 
    playfair_cipher = PlayFairCipher()  # Đồng bộ chữ F hoa
